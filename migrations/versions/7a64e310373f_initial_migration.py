...
Revision ID: 7a64e310373f
Revises: 
Create Date: 2024-09-12 11:47:26.569735
...
def downgrade():
    ...
    sa.Column('nome_usuario', mysql.VARCHAR(length=50), nullable=False),
    ...
    sa.Column('tipo_usuario', mysql.ENUM('admin', 'user'), server_default=sa.text("'user'"), nullable=False),
